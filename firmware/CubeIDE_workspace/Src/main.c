 ...
 ******************************************************************************
 * @file           : main.c
 * @brief          : Minimal STM32F103C8T6 CubeIDE bring-up firmware.
 ******************************************************************************
 */
...
{
    /* Keep the default internal 8 MHz HSI clock for the first bring-up. */
}
...
static void command_handle_line(const char *line)
{
    ...
    uart_write_line("ERROR code=0x0001 name=ERR_BAD_COMMAND message=\"unknown command\"");
}
